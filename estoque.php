...
<div class="estoque-container">
    ...
    <div class="card-button">
        <?php if (isset($_SESSION['nivel_acesso']) && $_SESSION['nivel_acesso'] == 2): ?>
            <a href="recebimento.php" class="card registrar">Inserir Produtos</a>
            ...
            <tbody>
                <?php while($product = $result->fetch_assoc()): ?>
                    <tr>
                        ...
                        <td>
                        <a href="editarprodutos.php?id=<?= $product['id'] ?>" class="btn btn-success btn-sm">Editar</a>
                        <a href="?excluir=<?= $product['id'] ?>" class="btn btn-danger btn-sm" onclick="return confirm('Tem certeza que deseja excluir este produto?')">Excluir</a>
                        </td>
                    </tr>
                <?php endwhile; ?>
            </tbody>
