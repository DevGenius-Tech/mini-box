...
$dsn = "mysql:host=localhost;dbname=comercio";
$username = "root";
$password = "";
...
try {
    ...
    $periodo = filter_input(INPUT_POST, 'periodo', FILTER_DEFAULT) ?? 'dia';
    $data_inicio = filter_input(INPUT_POST, 'data_inicio', FILTER_DEFAULT);
    $data_fim = filter_input(INPUT_POST, 'data_fim', FILTER_DEFAULT);
...
<body>
    <a href="dashboard.php" class="btn-back"><i class="bi bi-arrow-left-square-fill"></i> Voltar</a>
        <br><br>
    <header>
    ...
    <div class="content">
        ...
        <div class="card">
            ...
            <div class="saldo-item">
                ...
                <span><strong>R$ <?= number_format($resumo_avarias['total_avarias'] ?? 0, 2, ',', '.'); ?></strong></span>
            </div>
            <div class="saldo-item">
